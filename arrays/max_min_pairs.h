...
// The trick is to sort and then in each pair the first element is smaller than
// and second one then you sum up all minimums.
// 1 2 2 5 6 6
//  1   2   6   = 9

#ifndef MAX_MIN_PAIRS_H
#define MAX_MIN_PAIRS_H
#include <cstdint>
#include <vector>
